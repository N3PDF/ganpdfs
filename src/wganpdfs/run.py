...
def main():
    ...
    parser.add_argument(
        "runcard", action="store", default=None, help="A json file with the setup."
    )
    parser.add_argument(
        "--output",
        "-o",
    ...
    parser.add_argument(
        "--pplot", default=None, type=int, help="Define the number of output replicas."
    )
    parser.add_argument(
        "--flavors", default=None, type=int, help="Choose the falvours."
    )
